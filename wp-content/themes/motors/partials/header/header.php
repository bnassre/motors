			...
			<div class="mobile-menu-holder">
				<ul class="header-menu clearfix">
					...
					<?php if(!empty($compare_page)): ?>
						<li><a href="<?php echo esc_url(get_the_permalink($compare_page)); ?>"><?php _e('Compare', 'motors'); ?></a></li>
					<?php endif; ?>
					<?php if(!empty($woocommerce_shop_page_id)): ?>
						<li><a href="<?php echo esc_url($woocommerce_shop_page_id); ?>"><?php _e('Cart', 'motors'); ?></a></li>
					<?php endif; ?>
				</ul>
			</div>
						...
						<div class="pull-right">
							<div class="header-main-phone heading-font">
								...
								<div class="phone">
									...
									<?php endif; ?>
									<span class="phone-number heading-font"><a href="tel:<?php printf(esc_html__( '%s', 'motors' ), $header_main_phone ); ?>"><?php printf(esc_html__( '%s', 'motors' ), $header_main_phone ); ?></a></span>
								</div>
							</div>
						</div>
					<?php endif; ?>
								...
								<div class="address">
									<?php if(!empty($header_address)): ?>
										...
										<?php if(!empty($header_address_url)): ?>
											<span class="fancy-iframe" data-url="<?php echo esc_url($header_address_url,'motors'); ?>">
