	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Vehicle price",'motors');?> <span class="orange">(<?php echo $currency_symbol; ?>)</span></div>
			...
			<div class="row">
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group md-mg-rt">
						<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Interest rate",'motors');?> <span class="orange">(%)</span></div>
				...
				<div class="col-md-6 col-sm-6">
					...
					<div class="form-group md-mg-lt">
						<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Period",'motors');?> <span class="orange">(<?php esc_html_e('month','motors'); ?>)</span></div>
			...
			<!--Down Payment-->
			<div class="form-group">
				<div class="labeled <?php if(!empty($label_font_size)){ echo 'heading-font'; } ?>"><?php esc_html_e("Down Payment",'motors');?> <span class="orange">(<?php echo $currency_symbol; ?>)</span></div>
		...
		<div class="col-md-12">
			<div class="stm_calculator_results">
				<div class="stm-calc-results-inner">
					<div class="stm-calc-label"><?php esc_html_e('Monthly Payment', 'motors'); ?></div>
					<div class="monthly_payment h5"></div>

					<div class="stm-calc-label"><?php esc_html_e('Total Interest Payment', 'motors'); ?></div>
					<div class="total_interest_payment h5"></div>

					<div class="stm-calc-label"><?php esc_html_e('Total Amount to Pay', 'motors'); ?></div>
