...
<?php if($show_price and !$show_sale_price): ?>
	...
	<?php if(!empty($car_price_form) and $car_price_form == 'on'): ?>
		<a class="rmv_txt_drctn" href="" data-toggle="modal" data-target="#get-car-price">
	<?php endif; ?>

		<div class="single-car-prices<?php echo esc_attr($css_class); ?>">
...
<?php if($show_price and $show_sale_price): ?>
	...
	<?php if(!empty($instant_savings_label)): ?>
		...
		<div class="sale-price-description-single">
			<?php printf(esc_html__( '%s', 'motors' ), $instant_savings_label ); ?><strong> <?php echo esc_attr(stm_listing_price_view($savings)); ?></strong>
		</div>
	<?php endif; ?>
